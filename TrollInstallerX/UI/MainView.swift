...
struct MainView: View {
    ...
    var body: some View {
        GeometryReader { geometry in
            ZStack {
                ZStack {
                    LinearGradient(colors: [Color(hex: 0x121212)], startPoint: .topLeading, endPoint: .bottomTrailing)
                        .ignoresSafeArea()
                    VStack {
                        VStack {
                            /*Image("Icon")
                                ...
                                .shadow(radius: 10)*/
                            Text("TrollInstallerDark")
                                .font(.system(size: 30, weight: .semibold, design: .rounded))
                                .foregroundColor(.white)
                            Text("Based on TrollInstallerX By Alfie CG")
